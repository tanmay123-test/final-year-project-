...
const Profile = () => {
  ...
  const initial = (info?.user_name || 'U').trim().charAt(0).toUpperCase();
  const subtitle = info?.username ? `${info.username}` : '';
  ...
  return (
    <div className="profile-page">
      ...
      <div className="list">
        <button className="item"><span>Settings</span><ChevronRight size={18} /></button>
        <button className="item"><span>Help & Support</span><ChevronRight size={18} /></button>
        <button className="item"><span>Terms & Conditions</span><ChevronRight size={18} /></button>
      </div>
